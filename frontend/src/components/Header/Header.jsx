...
function Header() {
    ...
    return (
        <div>
            <nav className='header bg-blue-200 flex justify-between items-center'>
                ...
                <div className='flex justify-between'>
                    {
                        token ? (
                            <div className='flex items-center justify-center'>
                                <p className='mr-5'>welcome, <span className=' text-xl text-pink-800 capitalize'>{user.name}</span></p>
